...
! function(e, t) {
    ...
    var t = {
        ...
        s = function() {
            ...
            function i(r) {
                s && s.ptrElement && e.enable && (e.pullStartY ? e.pullMoveY = n(r) : s.shouldPullToRefresh() && (e.pullStartY = n(r)), "refreshing" !== e.state ? ("pending" === e.state && (s.ptrElement.classList.add(s.classPrefix + "pull"), e.state = "pulling", t.update(s)), e.pullStartY && e.pullMoveY && (e.dist = e.pullMoveY - e.pullStartY), e.distExtra = e.dist - s.distIgnore, e.distExtra > 0 && (r.preventDefault(), s.ptrElement.style[s.cssProp] = e.distResisted + "px", e.distResisted = s.resistanceFunction(e.distExtra / s.distThreshold) * Math.min(s.distMax, e.distExtra), "pulling" === e.state && e.distResisted > s.distThreshold && (s.ptrElement.classList.add(s.classPrefix + "release"), e.state = "releasing", t.update(s)), "releasing" === e.state && e.distResisted < s.distThreshold && (s.ptrElement.classList.remove(s.classPrefix + "release"), e.state = "pulling", t.update(s)))) : s.shouldPullToRefresh() && e.pullStartY < e.pullMoveY && r.preventDefault())
            }
        ...
        r = {
            ...
            instructionsPullToRefresh: "Tarik Kebawah Untuk Memuat",
            instructionsReleaseToRefresh: "Lepaskan Untuk Memuat Ulang",
            instructionsRefreshing: "Memuat Ulang Halaman",
            refreshTimeout: 500,
            getMarkup: function() {
